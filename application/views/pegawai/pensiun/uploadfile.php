                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <?php $file = $this->db->get_where('file',['pegawai_id' => $this->session->userdata('id'),'jenis' => 1])->result();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php else : ?>
                                                        ...
                                                        <?php else : 
                                                            $pegawai = $this->db->get_where('pegawai',['id' => $f->pegawai_id])->row(); ?>

                                                            <a href="<?= base_url('upload_berkas/'.$pegawai->nama.'/'.$f->file); ?>" target="_blank" class="badge badge-primary">Lihat Berkas</a>

                                                            <a href="<?= base_url('pegawai/pensiun/hapusfile/'.$f->id); ?>" class="badge badge-danger">Hapus</a>
                                    ...
                                    <a href="<?= base_url('pegawai/pensiun/cekberkas') ?>" class="mt-3 btn btn-primary">Selanjutnya</a>

                                    <a href="<?= base_url('pegawai/pensiun/detailpengajuan') ?>" class="mt-3 btn btn-secondary">Sebelumnya</a>
