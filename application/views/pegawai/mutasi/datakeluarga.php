                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                <?php $i=1; foreach($keluarga as $k) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $k->status ?></td>
                                                        <td>
                                                            <a href="<?= base_url('/mutasi/hapusdatakeluarga/'.$k->id) ?>" onclick="return confirm('Hapus?');" class="badge badge-danger float-right tombol-hapus mb-1">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                <?php if(!$keluarga) : ?>
                                    ...
                                    <a href="<?= base_url('/mutasi/detailpengajuan') ?>" class="mt-3 btn btn-primary">Selanjutnya</a>

                                    <a href="<?= base_url('/mutasi') ?>" class="mt-3 btn btn-secondary">Sebelumnya</a>
