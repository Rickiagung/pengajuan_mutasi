                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            <?php $pegawai = $this->db->get_where('keluarga',['pegawai_id' => $pengajuan->pegawai_id])->result(); ?>
                                ...
                                <div class="col-md-8">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php $file = $this->db->get_where('file',['pegawai_id' => $pengajuan->pegawai_id, 'jenis' => 1])->result();
                                            // var_dump($file);die;
                                            ?>
                                            ...
                                            <a href="<?= base_url('pimpinan/pensiun/cekdatasave/'.$pengajuan->pegawai_id) ?>" class="btn btn-primary mt-4">Save</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
